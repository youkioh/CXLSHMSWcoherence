...
static const unsigned long fh_action_table[32] = {
    ...
    /* - - - - */ FH_ACTION_RESPOND,
    /* - - - S */ FH_ACTION_RESPOND,
    /* - - M - */ FH_ACTION_RESPOND | FH_ACTION_WRITEBACK,
    /* - - M S */ FH_ACTION_RESPOND,
    /* - W - - */ FH_ACTION_RESPOND,
    /* - W - S */ FH_ACTION_INVALIDATE | FH_ACTION_RESPOND,
    /* - W M - */ FH_ACTION_WRITEBACK | FH_ACTION_INVALIDATE | FH_ACTION_RESPOND,
    /* - W M S */ FH_ACTION_INVALIDATE | FH_ACTION_RESPOND,
    /* R - - - */ FH_ACTION_RESPOND,
    /* R - - S */ FH_ACTION_RESPOND,
    /* R - M - */ FH_ACTION_RESPOND | FH_ACTION_WRITEBACK,
