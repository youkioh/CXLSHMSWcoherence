...
enum pcn_kmsg_type {
	...
	PCN_KMSG_TYPE_REMOTE_PROC_PS_RESPONSE,
        ...
        PCN_KMSG_TYPE_MEM_REASSIGN_REQUEST,
        PCN_KMSG_TYPE_MEM_REASSIGN_RESPONSE,
...
//FOR SHM FEATURES
	volatile unsigned long last_ticket; //if it is last one for read. 
	volatile unsigned char ready; // the message is ready for use.
